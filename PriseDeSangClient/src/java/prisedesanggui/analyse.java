...
public class analyse extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        typeBG.add(hematie);
        hematie.setText("HÈmaties");

        hemoglo.setText("HÈmoglobine");

        typeBG.add(hemato);
        hemato.setText("HÈmatocrite");
    ...
    private void OKButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKButtonActionPerformed
        // Encodage des donn√©es sur le patient dans la BDD
        try {
            InitialContext ctx = new InitialContext();
        ...
        // Generation du numero de r√©ference ( = id demande )
